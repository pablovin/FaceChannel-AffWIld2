...
def ccc(y_true, y_pred):
    if K.backend() == 'tensorflow':
        ...
        # argmaxYTrue = tf.multiply(tf.keras.backend.argmax(y_true), 0.1)
        # if argmaxYTrue > 10:
        #     argmaxYTrue = argmaxYTrue - 0.1
        # else:
        #     argmaxYTrue = - argmaxYTrue
        #
        # y_true = argmaxYTrue
        #
        #
        # argmaxYPred = tf.multiply(tf.keras.backend.argmax(y_pred), 0.1)
        # if argmaxYPred > 10:
        #     argmaxYPred = argmaxYPred - 0.1
        # else:
        #     argmaxYPred = - argmaxYPred
        #
        # y_pred = argmaxYPred
