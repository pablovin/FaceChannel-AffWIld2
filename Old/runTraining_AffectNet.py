...
print("Reading load data:" + str(file))
for imgFile in imageList:
    img = trainDataSet+"/"+imgFile
    trainingSamples.append(img)
    arousal = float(imgFile.split('__')[2])
    valence = float(imgFile.split('__')[3][0:-4])
