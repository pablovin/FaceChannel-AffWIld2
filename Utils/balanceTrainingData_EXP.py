...
balancedTraining = "/home/pablo/Documents/Datasets/affwild2/balancedAnnotationsTraining_Exp/"
                    ...
                    if os.path.exists(fileName):
                       ...
                       """
                        ...
                        if expression == 5 and valence > 0:
                            affConsistence = False
                        # #
                        if expression == 0 and not (valence > -0.1 and valence < 0.1) and not (arousal > -0.1 and arousal < -0.1):
                            affConsistence = False

                        if affConsistence:
                            newFile.write(str(expression)+"\n")
                        else:
                            framesOut +=1
                            newFile.write(str(-1)+"\n")
                    else:
